...
/*   Updated: 2024/01/12 12:07:52 by aabourri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ms_exec_in(t_data *data, pid_t *pid);
int		ms_exec_pipe(t_ast *node, t_data *data, pid_t *pid);
int		ms_exec_cmd(t_ast *node, t_data *data, pid_t *pid);
int		ms_exec(t_ast *ast, t_data *data, pid_t *pid);
